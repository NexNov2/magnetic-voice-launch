        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-yellow-soft text-yellow-soft hover:bg-yellow-soft hover:text-primary font-bold text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-4 sm:py-6 w-full sm:w-auto bg-transparent h-auto whitespace-normal text-center leading-tight"
            >
